...
def collectDF():
    ...
    writePath = "popstar_results/ternary_video_compare_%s_%s.txt" % (inp1,inp2)
    writePath1 = "popstar_results/energy_video_compare_%s_%s.txt" % (inp1,inp2)
    writePath2 = "popstar_results/control_video_compare_%s_%s.txt" % (inp1,inp2)
    writePath3 = "popstar_results/surprise_video_compare_%s_%s.txt" % (inp1,inp2)
    ...
    for fname in dir_list:
        print(fname)
        dirname = fname
        readPath = "%s_analysis/ternary_video_norm_%s.txt" % (inp1,dirname)
...
def KruskalWallis():
    ...
    energy_p = round(p,3)
    readPath = "popstar_results/control_video_compare_%s_%s.txt" % (inp1,inp2)
    df = pd.read_csv(readPath, sep = "\t")
    ...
    control_p = round(p,3)
    readPath = "popstar_results/surprise_video_compare_%s_%s.txt" % (inp1,inp2)
    df = pd.read_csv(readPath, sep = "\t")
...
def main():
    ...
    print("\nsignal comparison on video is complete\n")   
