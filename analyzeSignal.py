...
def norm_data():
    ...
    if(spchOpt == "yes"):  # note: z score is rescaled from -1,1 to 0,1
        ...
        sd = 0.0395333786358711
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'AMPvalues'
        mean =  20.7914742010983 
        sd = 3.47962443804904
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'BIVvalues'
        mean = 5.98649033042587  
        sd = 1.40726383546686
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'EVIvalues'
        mean = 6.1858725958132
        sd = 4.70959912676407
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'FFVvalues'
        mean = 1.26083896717256  
        sd = 2.12051156046947
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'HENvalues'
        mean = 9.05617854033038  
        sd = 1.0689492090942
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'LZCvalues'
        mean = 12.7063245742931  
        sd = 0.390230756016193
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'MSEvalues'
        mean = 0.810814198579961  
        sd = 0.569137483747565
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'NVIvalues'
        mean = 0.702314879787905  
        sd = 0.0971641561977341
        df_norm[column] = np.array((((df_norm[column]-mean)/sd)*sf+1)/2)
        column = 'TEMPOvalues'
